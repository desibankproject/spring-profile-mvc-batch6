...
public class CustomerDao implements ICustomerDao {
	...
	public void save(CustomerEntity customer){
		...
		System.out.println("Before saving\n");
		String sql1="insert into customer_tbl(name,email,gender,mobile,photo,city) values(?,?,?,?,?,?)";
		...
		String sql2="insert into customer_history_tbl(name,email,gender,mobile,photo,city) values(?,?,?,?,?,?)";
